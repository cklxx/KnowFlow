...
export const Input = forwardRef<HTMLInputElement, InputProps>(
  ({ label, error, helperText, fullWidth = false, className = '', id, ...props }, ref) => {
    ...
    const baseStyles =
      'px-3 py-2 border rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 bg-white dark:bg-secondary-900 text-secondary-900 dark:text-secondary-100';
